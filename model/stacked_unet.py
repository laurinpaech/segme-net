...
def unet(pretrained_weights=None, input_size=(None, None, 3), nr_of_stacks=1):
    ...
    for i in range(nr_of_stacks - 1):
        ...
        conv1_2 = Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal', dilation_rate=2)(
            conv1_2)
        ...
        conv2_2 = Conv2D(128, 3, activation='relu', padding='same', kernel_initializer='he_normal', dilation_rate=2)(
            conv2_2)
        pool2_2 = MaxPooling2D(pool_size=(2, 2))(conv2_2)
        conv3_2 = Conv2D(256, 3, activation='relu', padding='same', kernel_initializer='he_normal')(pool2_2)
        conv3_2 = Conv2D(256, 3, activation='relu', padding='same', kernel_initializer='he_normal', dilation_rate=2)(
            conv3_2)
        ...
        conv4_2 = Conv2D(512, 3, activation='relu', padding='same', kernel_initializer='he_normal', dilation_rate=2)(
            conv4_2)
        drop4_2 = Dropout(0.25)(conv4_2)
        ...
        drop5_2 = Dropout(0.25)(conv5_2)

        # Expansive path
        up6_2 = Conv2D(512, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        ...
        up7_2 = Conv2D(256, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        ...
        up8_2 = Conv2D(128, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        ...
        up9_2 = Conv2D(64, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
