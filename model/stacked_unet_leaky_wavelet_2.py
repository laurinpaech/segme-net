...
"""
This model uses 3 wavelet levels in both stacks (2 stacks max atm)
...
def unet(pretrained_weights=None, input_size=(None, None, 3), nr_of_stacks=1):
    ...
    for i in range(nr_of_stacks - 1):
        ...
        L1_2 = Input(shape=(None, None, 3))
        laplace_2_2 = Input(shape=(None, None, 1))
        merge2_2 = concatenate([conv2_2, L1_2, laplace_2_2], axis=3)

        pool2_2 = MaxPooling2D(pool_size=(2, 2))(merge2_2)
        ...
        L2_2 = Input(shape=(None, None, 3))
        laplace_4_2 = Input(shape=(None, None, 1))
        merge3_2 = concatenate([conv3_2, L2_2, laplace_4_2], axis=3)

        pool3_2 = MaxPooling2D(pool_size=(2, 2))(merge3_2)
        ...
        L3_2 = Input(shape=(None, None, 3))
        laplace_8_2 = Input(shape=(None, None, 1))
        merge4_2 = concatenate([drop4_2, L3_2, laplace_8_2], axis=3)

        pool4_2 = MaxPooling2D(pool_size=(2, 2))(merge4_2)
