...
def segnet(input_shape=(400, 400, 3), n_labels=1, pretrained_weights=None, kernel=3, pool_size=(2, 2), output_mode="softmax"):
    # encoder
    ...
    outputs = Convolution2D(n_labels, (1, 1), padding="valid")(conv_25)
